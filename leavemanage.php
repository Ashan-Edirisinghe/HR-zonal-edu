        ...
        <div class="p-3" style="background-color:rgba(224, 224, 224, 0.94);">
          ...
          <script>
            ...
            function submitForm() {
              if (!formSubmitted) {
                ...
                document.getElementById('autoSubmitForm').submit(); // Submit the form
              }
            }
          </script>
          ...
          if ($_SESSION['leavenotice'] === true) { ?>
            ...
            <div class="mt-3 ">
              ...
              <form method="POST" action="backend/leavecon.php">

                <select class="form-select" aria-label="Default select example" name="comment">
