...
<header> 
    ...
    <nav class="navbar navbar-expand-lg " style="background-color: rgba(224, 224, 224, 0.94);">
      ...
      <div class="container">
    <div class="row">
        <div class="col-sm-6 mx-auto g-2 ">
            <div class="d-flex justify-content-center align-items-center" style="height:  50vh:;">
                <div class=" p-4  rounded" style="background-color: rgba(224, 224, 224, 0.94);width:100vw;height:50vh;">
                    <form action="/submit_notice" method="post" class="text-center">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea id="message" name="message" class="form-control " style="height: 20vh;"></textarea>
                        </div>
                        <div class="submit">
                            <button type="submit" class="btn btn-light bg-primary text-white">Send</button>
                        </div>
                    </form>
                </div>
            </div>
